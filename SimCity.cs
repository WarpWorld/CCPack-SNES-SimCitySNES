    ...
    public class SimCity : SNESEffectPack
    {
        ...
        public override List<Effect> Effects
        {
            get
            {
                ...
                effects.AddRange(_game_messages.Take(33).Select(t => new Effect($"{t.Value.MessageName}", $"helpfulmessage_{t.Key}", "helpfulmessage")));
        ...
        public override Game Game { get; } = new Game(49, "Sim City", "SimCity", "SNES", ConnectorType.SNESConnector);
